...
class AgendaController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("tanggal","waktu","kodeguru","kodemapel","kelas","materi","jumlahsiswa","tidakhadir","ijin","photo");
		...
		$page_title = $this->view->page_title = "Add New Agenda";
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("kodeagenda","tanggal","waktu","kodeguru","kodemapel","kelas","materi","jumlahsiswa","tidakhadir","ijin","photo");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'tanggal' => 'required',
